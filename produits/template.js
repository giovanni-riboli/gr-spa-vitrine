          ...
          if (grid) {
            grid.innerHTML = similar.map(function(s) {
              return '<a href="../produits/' + s.slug + '.html" class="similar-card">' +
                '<img src="../assets/produits/' + s.slug + '.webp" alt="' + s.nom + '" style="width:100%;height:120px;object-fit:contain;border-radius:6px;background:#f8f6f2;margin-bottom:12px" onerror="this.style.display='none'">' +
